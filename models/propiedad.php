...
class Propiedad extends ActiveRecord {
    ...
    public function validar() {
        ...
        if(!$this->titulo) {
            self::$errores [] = "Debes agregar titulo";
        }
        if(!$this->precio) {
            self::$errores [] = "Debes agregar precio";
        }
        ...
        if(!$this->wc) {
            self::$errores [] = "Debes agregar el numero de baños";
        }
        if(!$this->estacionamiento) {
            self::$errores [] = "Debes agregar el estacionamiento";
        }
